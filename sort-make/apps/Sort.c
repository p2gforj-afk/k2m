...
/**
 * @brief Display the commande usage.
 **/
void usage(){
  ...
  fprintf(stderr, "\t sort	        \t standard mod         	  \n");
  fprintf(stderr, "\n");
  fprintf(stderr, "Examples:								    \n");
  fprintf(stderr, "./bin/Sort -m test						    \n");
  fprintf(stderr, "./bin/Sort -m generation -o /tmp/test.txt -n 50000000		    \n");
  fprintf(stderr, "./bin/Sort -m lineCount -i /tmp/test.txt				    \n");
  fprintf(stderr, "./bin/Sort -m demoSort -i /tmp/test.txt -o /tmp/test.sort.txt	    \n");
  fprintf(stderr, "./bin/Sort -m demoSortSplit -i /tmp/test.txt -o /tmp/test.sort.txt    \n");
  fprintf(stderr, "./bin/Sort -m sort -i /tmp/test.txt -o /tmp/test.sort.txt -k 5   \n");
}
